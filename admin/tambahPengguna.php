                        ...
                        <div class="card shadow mb-4">
                            ...
                            <form method="post" action="prosesTambahPengguna.php">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_pengguna" id="nama_pengguna" placeholder="Masukkan Nama Pengguna" required>
                                </div>
                                <div class="form-group">
                                    <label for="username">Username</label>
                                    <input type="text" class="form-control" name="username" id="username" placeholder="Masukkan Username" pattern="^(?![_.])(?!.*[_.]{2})[a-zA-Z0-9._]+(?<![_.])$" minlength="5" aria-describedby="usernameValidation" required>
                                    <div id="usernameValidation" class="validationMessage"></div>
                                </div>
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input type="email" class="form-control" name="email" id="email" placeholder="Masukkan Email" autocomplete="email" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="jabatan" id="jabatan">
                                        ...
                                        <option value="Apoteker Penanggung Jawab">Apoteker Penanggung Jawab</option>
