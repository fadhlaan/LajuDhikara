...
<?php
    ...
    $stmt = $conn->prepare("SELECT * FROM jenis WHERE id_jenis=?");
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Ubah Jenis Data Obat</h6>
                            </div>
                            <div class="card-body">
                            <form method="post" action="prosesUbahJenis.php">
                                <div class="form-group">
                                    <label for="idJenis">ID Jenis Obat</label>
                                    <input type="text" class="form-control" name="id_jenis" id="id_jenis" placeholder="" value="<?php echo htmlspecialchars($row['id_jenis']); ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="namaJenis">Nama Jenis Obat</label>
                                    <input type="text" class="form-control" name="nama_jenis" id="nama_jenis" placeholder="Masukkan Nama Jenis" value="<?php echo htmlspecialchars($row['nama_jenis']); ?>" required>
                                </div>
