                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="obat.php" class="btn btn-primary shadow h-100 py-2 w-100 d-flex flex-column align-items-center justify-content-center">
                                <div class="icon mb-2">
                                    <i class="fas fa-pills fa-2x text-white"></i>
                                </div>
                                <div class="text-center">
                                    <div class="h5 mb-0 font-weight-bold text-white">Data Obat</div>
                                </div>
                            </a>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <h1 class="h4 mb-4 text-gray-800">Selamat Datang Asisten Apoteker</h1>
