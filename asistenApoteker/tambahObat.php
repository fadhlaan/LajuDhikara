                            ...
                            <form method="POST" action="prosesTambahObat.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="jenis" name="jenis" required>
                                        <?php while ($rowJenis = mysqli_fetch_assoc($resJenis)) : ?>
                                            <option value="<?= $rowJenis['id_jenis']; ?>"><?= $rowJenis['nama_jenis']; ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="satuan" name="satuan" required>
                                        <?php while ($rowSatuan = mysqli_fetch_assoc($resSatuan)) : ?>
                                            <option value="<?= $rowSatuan['id_satuan']; ?>"><?= $rowSatuan['nama_satuan']; ?></option>
                                        <?php endwhile; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="supplier" name="supplier" required>
                                        <?php while ($rowSupplier = mysqli_fetch_assoc($resSupplier)) : ?>
