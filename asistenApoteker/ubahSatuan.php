...
<?php
    ...
    if (!$row) {
        die("Satuan dengan ID tersebut tidak ditemukan. Apakah Anda yakin ID Satuan tersebut ada?");
    }
?>
<html lang="en">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                            <form method="post" action="prosesUbahSatuan.php">
                                <div class="form-group">
                                    <label for="idSatuan">ID Satuan</label>
                                    <input type="text" class="form-control" name="id_satuan" id="id_satuan" placeholder="" value="<?php echo htmlspecialchars($row['id_satuan']); ?>" readonly>
                                </div>
                                <div class="form-group">
